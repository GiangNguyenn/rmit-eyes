      ...
      <div className={classes.listContainer}>
        <MaterialTable
          ...
          columns={[
            ...
            {
              title: 'Status',
              render: (rowData) => <div>{rowData.status === 'pending_to_approve' ?
                <Tag icon={<SyncOutlined spin/>} color="processing">Pending</Tag> :
                <Tag icon={<CheckCircleOutlined/>} color="success">Approved</Tag>}</div>
            },
            {
              title: 'Approve',
              field: '',
            ...
            props.approve ? {
              title: 'Details',
              field: '',
              render: (rowData) => <Button variant="contained" color="success"
                                           onClick={() => handleApprove(rowData.sid)}>Approve</Button>
              ,
            } : {}
          ]}
          actions={[
